                            ...
                            <form class="form-horizontal" method="post" action="{{ url('admin/job_grades/edit/'.$getRecord->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="grade_level" value="{{ $getRecord->grade_level }}" class="form-control" required placeholder="Enter Grade Level">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" name="lowest_salary" value="{{ $getRecord->lowest_salary }}" class="form-control" required placeholder="Enter Lowest Salary">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" name="highest_salary" value="{{ $getRecord->highest_salary }}" class="form-control" required placeholder="Enter Highest Salary">
                                        </div>
                                    </div>
